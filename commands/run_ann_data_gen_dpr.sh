...
#out_data_dir="/checkpoint/mdrizwanparvez/data/DPR_PUBLIC/data/QA_NQ_data/" # change this for different data_type
...
SWEEP_NAME=ANCE_DPR_DATA_GEN_SINGLESET_PRED_ON_${prediction_dataset}
queue=learnfair
queue=dev
num_nodes=1
port=54187
